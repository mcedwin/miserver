...
class Users extends BaseController
{
  ...
  // function borrar_dominio($domain)
  // {
  //   // Carga el archivo de configuración
  //   $awsConfig = $this->config->services['awsConfig'];

  //   // Configura el cliente de Route 53
  ...
  //           'Action' => 'UPSERT',
  //           'ResourceRecordSet' => [
  //             'Name' => $domain, // Reemplaza con tu nombre de dominio
  //             'Type' => 'A',
  //             'TTL' => 300,
  //             'ResourceRecords' => [
  //               [
  ...
  //             'ResourceRecords' => [
  //               [
  //                 'Value' => $ipAddress, // Reemplaza con la dirección IP que deseas eliminar
  //               ],
  //             ],
  //           ],
  //         ],
