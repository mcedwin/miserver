...
$_COOKIE['_sfm_xsrf'] = isset($_COOKIE['_sfm_xsrf']) ? $_COOKIE['_sfm_xsrf'] : '';
$_GET['do'] = isset($_GET['do']) ? $_GET['do'] : '';

$_POST['do'] = isset($_POST['do']) ? $_POST['do'] : '';
$_POST['xsrf'] = isset($_POST['xsrf']) ? $_POST['xsrf'] : '';

$_SESSION['_sfm_allowed'] = isset($_SESSION['_sfm_allowed']) ? $_SESSION['_sfm_allowed'] : '';
