...
$ROUTES = [
    ...
    ['GET',  '/domains/{i}/edit',   ['domains', 'edit']],
    ['POST', '/domains/{i}/update', ['domains', 'update']],
    ...
    ['POST', '/files/chown',        ['files',   'chown']],
    ['POST', '/files/delete',       ['files',   'delete']],

    ['GET',  '/apps',               ['apps',    'index']],
    ['GET',  '/apps/create',        ['apps',    'create']],
    ['POST', '/apps',               ['apps',    'store']],
    ['GET',  '/apps/{i}/edit',      ['apps',    'edit']],
    ['POST', '/apps/{i}/update',    ['apps',    'update']],
    ['GET',  '/apps/{i}/env',       ['apps',    'env']],
    ['POST', '/apps/{i}/env',       ['apps',    'env_save']],
    ['POST', '/apps/{i}/env-from-example', ['apps', 'env_from_example']],
    ['POST', '/apps/{i}/deploy',    ['apps',    'deploy']],
    ['POST', '/apps/{i}/pull',      ['apps',    'pull']],
    ['POST', '/apps/{i}/migrate',   ['apps',    'migrate']],
    ['POST', '/apps/{i}/reinstall', ['apps',    'reinstall']],
    ['POST', '/apps/{i}/delete',    ['apps',    'delete']],
    ...
    ['POST', '/security/ban',       ['security', 'ban']],
    ['POST', '/security/unban',     ['security', 'unban']],
    ['POST', '/security/clear',     ['security', 'clear']],
